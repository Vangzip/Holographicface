...
int main(int argc, char** argv)
{
	...
	// load pcd file
	if (pcl::io::loadPCDFile<pcl::PointXYZ>("F:\\work\\PCL\\02\\DSC_9783-1_rgb.pcd"/*"F:\\work\\PCL\\icp\\rabbit.pcd"*/, *cloud_source) == -1) {
		std::cout << "load source failed!" << std::endl;
		return -1;
	}
	std::cout << "source loaded!" << std::endl;

	if (pcl::io::loadPCDFile<pcl::PointXYZ>("F:\\work\\PCL\\02\\DSC_9783-1_rgb.pcd", *cloud_target) == -1) {
