...
public:
	...
	bool depthToPlyColor(const std::string &depthImageSrc, const std::string &colorImage);
    ...
    double getDepthMicro2MainDis(double mainFocusPlane, double mainFocusLength, double microFocusLength, double microB, double microDiameter);
...
private:
    ...
    int m_movelLabel, m_lableNum, m_passThrough, m_patch;
};